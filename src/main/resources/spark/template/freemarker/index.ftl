  ...
  <div class="w3-row-padding">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          ...
          <div class="w3-display-bottomleft w3-container w3-text-black">
            <h2 class="w3-white">Ignacio Gallardo</h2>
          </div>
        </div>
        <div class="w3-container">
          <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i>Software Engineer</p>
          <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>Corrientes, AR</p>
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>ignaciomgu@gmail.com</p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>+54 11 65710498</p>
          <hr>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b>PHP Developer / Invgate</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Jul 2015 - Nov 2016</h6>
          <p>Desarrollo de aplicaciones Web orientadas al IT Magement.</p>
          <hr>
        </div>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Java Developer / Gilbarco Veeder-root LTA.</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Feb 2015 - Jul 2015</h6>
      ...
      <div class="w3-container w3-card-2 w3-white">
        ...
        <div class="w3-container">
         ...
         <div class="w3-container">
          <h5 class="w3-opacity"><b>Universidad de Palermo</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2009 - 2014</h6>
          <p>Licenciatura en Sistemas</p><br>
        </div>
         <div class="w3-container">
          <h5 class="w3-opacity"><b>Universidad de Palermo</b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>2009 - 2013</h6>
          <p>Analista Universitario en Sistemas</p><br>
        </div>
...
<footer class="w3-container w3-teal w3-center w3-margin-top">
  <p>Encontrame en las redes sociales.</p>
  <a href="https://www.facebook.com/ignaciomartin.gallardo" target="_blank"><i class="fa fa-facebook-official w3-hover-opacity"></i>
  <a href="https://www.linkedin.com/in/ignacio-martin-gallardo-64907a48/" target="_blank"><i class="fa fa-linkedin w3-hover-opacity"></i>
  <p>Hecho por <a href="https://www.linkedin.com/in/ignacio-martin-gallardo-64907a48/" target="_blank">Ing. Ignacio Gallardo</a></p>
</footer>
